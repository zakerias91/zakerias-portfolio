        ...
        <header className="header">
            ...
            <div className="top-bar container-fluid">
                <div className="actions">
                    <a className="btn d-none d-md-inline-block" href="https://uk.linkedin.com/in/zakerias-rowland-jones-9092338b"><FontAwesomeIcon icon={faPaperPlane} /> Hire Me</a>
                    <a className="btn" href="assets/files/CV_Zakerias_Online.pdf" target="_blank"><FontAwesomeIcon icon={faDownload} /> Download My Resume</a>
                </div>{/* actions */}

                {/* Social Links */}
                <ul className="social list-inline">
                    <li className="list-inline-item"><a href="https://uk.linkedin.com/in/zakerias-rowland-jones-9092338b"><FontAwesomeIcon icon={faLinkedinIn} /></a></li>
                    {/* <li className="list-inline-item"><a href="#"><i className="fab fa-twitter" aria-hidden="true"></i></a></li> */}
                    <li className="list-inline-item"><a href="https://github.com/zakerias91"><FontAwesomeIcon icon={faGithubAlt} /></a></li>
